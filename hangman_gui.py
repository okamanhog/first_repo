...
word_list = ["Quark", "Flibbertigibbet", "Gibberellin", "Zygomatic", "Bumfuzzle", "Lollygag", "Snickersnee", "Widdershins"]
...
letter_entry.place(x=150, y=350)
...
def create_hangman_pic(trial):
    ...
    img = Image.open(f"images/{trial}.webp")
